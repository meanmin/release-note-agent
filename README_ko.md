...
## GitHub Draft Release 자동 생성

`--repo`와 `--audience docs` 조합으로 실행하면, 릴리즈 노트 생성 후 **GitHub draft release를 자동으로 만들지** 물어봅니다.
...
GitHub 레포의 **Releases → Draft** 탭에서 확인하고, 검토 후 직접 publish할 수 있습니다.

> 주의: `gh` 로그인 상태여야 하고, 해당 레포에 write 권한이 있어야 합니다.
